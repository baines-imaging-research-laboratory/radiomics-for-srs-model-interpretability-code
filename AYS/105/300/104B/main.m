...
chExpReferenceCode = 'AYS-105-300-104';
...
for dBootstrapRepIndex=1:dNumBootstrapReps
    ...
    if dBootstrapRepIndex == 1
        ...
        [c1vdALEValuePerIntervalPerFeature, c1vdALEIntervalCentresPerFeatureInsert] = FileIOUtils.LoadMatFile(...
            fullfile(ExperimentManager.GetPathToExperimentAssetResultsDirectory(chExpReferenceCode), '01 ALE Analysis', chFilename),...
            'c1ALEValuePerIntervalPerFeature', 'c1vdIntervalCentresPerFeature');
        
        for dFeatureIndex=1:dNumFeatures
            if isempty(c1vdALEIntervalCentresPerFeature{dFeatureIndex})
                c1vdALEIntervalCentresPerFeature{dFeatureIndex} = c1vdALEIntervalCentresPerFeatureInsert{dFeatureIndex};
            end
        end
    end
