...
PROC IMPORT
	DATAFILE="E:\Users\ddevries\VUMC BM\Experiments\AYS\105\002\101 [2023-02-25_14.50.59]\Results\01 Analysis\SAS Analysis Export (Obs 3).xlsx"
	DBMS=xlsx
	OUT=work.KMData replace;

/* Open PDF to write results to */
ODS PDF FILE="E:\Users\ddevries\VUMC BM\Experiments\AYS\105\002\101-SAS\Results (Obs 3).pdf" style=Sapphire;
