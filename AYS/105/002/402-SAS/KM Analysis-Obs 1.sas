...
PROC IMPORT
	DATAFILE="E:\Users\ddevries\VUMC BM\Experiments\AYS\105\002\402 [2023-03-03_17.03.40]\Results\01 Analysis\SAS Analysis Export (Obs 1).xlsx"
	DBMS=xlsx
	OUT=work.KMData replace;

/* Open PDF to write results to */
ODS PDF FILE="E:\Users\ddevries\VUMC BM\Experiments\AYS\105\002\402-SAS\Results (Obs 1).pdf" style=Sapphire;
