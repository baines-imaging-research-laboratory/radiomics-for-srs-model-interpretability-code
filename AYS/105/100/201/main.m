...
dNumObservers = size(m2dAppearanceScorePerSamplePerObserver,2);
dNumSamples = size(m2dAppearanceScorePerSamplePerObserver,1);

m2dExportMatrix = zeros(numel(m2dAppearanceScorePerSamplePerObserver),3); % columns: sample id, observer id, score
