...
arguments
    ...
    NameValueArgs.TopErrorBarOnly = false
    NameValueArgs.GroupLabelOffset = 0
    NameValueArgs.GroupLabelVerticalAlignment = 'cap'
end
...
for dGroupIndex=1:dNumGroups
    ...
    text(dGroupIndex-0.5, vdYLim(1)-NameValueArgs.GroupLabelOffset, strsplit(vsLabelPerGroup(dGroupIndex), "\\n"), 'VerticalAlignment', NameValueArgs.GroupLabelVerticalAlignment, 'HorizontalAlignment', 'center', c1xVarargin{:});
end
...
if isfield(NameValueArgs, 'ErrorBarSizePerGroupPerVariable')
    ...
    for dGroupIndex=1:dNumGroups
        ...
        for dVariableIndex=1:dNumVariables
            if m2dErrorBarSizePerGroupPerVariable(dGroupIndex, dVariableIndex) ~= 0
                ...
                if NameValueArgs.TopErrorBarOnly
                    dUpperY = dValueY;
                else
