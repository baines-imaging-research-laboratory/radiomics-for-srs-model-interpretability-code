...
m2dRPAGroupPerSamplePerObserver = FileIOUtils.LoadMatFile(...
    fullfile(ExperimentManager.GetPathToExperimentAssetResultsDirectory('AYS-105-002-402'), '01 Analysis', 'RPA Groups Per Observer.mat'),...
    'm2dRPAGroupPerSamplePerObserver');
vdRPAGroupPerSample = m2dRPAGroupPerSamplePerObserver(:,dObserverIndex);
