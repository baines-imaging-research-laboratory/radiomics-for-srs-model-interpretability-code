...
dAppearanceScore = BrainMetastasisAppearanceScore.cysticComplex.GetFeatureValuesCategoryNumber();
...
oRecord = CustomFeatureExtractionRecord(sLBLCode, "Cystic Complex BM Appearance for Observer " + string(dObserver), m2dFeatures);
