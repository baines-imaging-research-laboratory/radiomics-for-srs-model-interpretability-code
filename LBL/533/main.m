...
dAppearanceScore = BrainMetastasisAppearanceScore.cysticSimple.GetFeatureValuesCategoryNumber();
...
oRecord = CustomFeatureExtractionRecord(sLBLCode, "Cystic Simple BM Appearance for Observer " + string(dObserver), m2dFeatures);
