...
viLabels = uint8(vdAppearance == BrainMetastasisAppearanceScore.heterogeneous.GetFeatureValuesCategoryNumber()); 
...
oRecord = CustomFeatureExtractionRecord("LBL-502", "Heterogeneous BM Appearance from FV-500-200", m2dFeatures);
