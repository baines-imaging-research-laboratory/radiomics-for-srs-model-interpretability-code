...
viLabels = uint8(vdAppearance == BrainMetastasisAppearanceScore.homogeneous.GetFeatureValuesCategoryNumber() | vdAppearance == BrainMetastasisAppearanceScore.heterogeneous.GetFeatureValuesCategoryNumber()); 
...
oRecord = CustomFeatureExtractionRecord("LBL-506", "Homogeneous or Heterogeneous BM Appearance from FV-500-200", m2dFeatures);
