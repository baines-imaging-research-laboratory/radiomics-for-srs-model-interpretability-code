...
dAppearanceScore = BrainMetastasisAppearanceScore.heterogeneous.GetFeatureValuesCategoryNumber();
...
oRecord = CustomFeatureExtractionRecord(sLBLCode, "Heterogeneous BM Appearance for Observer " + string(dObserver), m2dFeatures);
