...
viLabels = uint8(vdAppearance == BrainMetastasisAppearanceScore.homogeneous.GetFeatureValuesCategoryNumber()); 
...
oRecord = CustomFeatureExtractionRecord("LBL-501", "Homogeneous BM Appearance from FV-500-200", m2dFeatures);
