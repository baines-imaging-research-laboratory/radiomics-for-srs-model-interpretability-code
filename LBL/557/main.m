...
dAppearanceScore1 = BrainMetastasisAppearanceScore.necrosis.GetFeatureValuesCategoryNumber();
...
oRecord = CustomFeatureExtractionRecord(sLBLCode, "Heterogeneous or Necrosis BM Appearance for Expert Consensus", m2dFeatures);
