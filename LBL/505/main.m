...
viLabels = uint8(vdAppearance == BrainMetastasisAppearanceScore.necrosis.GetFeatureValuesCategoryNumber()); 
...
oRecord = CustomFeatureExtractionRecord("LBL-505", "Necrosis BM Appearance from FV-500-200", m2dFeatures);
