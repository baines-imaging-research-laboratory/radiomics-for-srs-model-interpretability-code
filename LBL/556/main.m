...
dAppearanceScore1 = BrainMetastasisAppearanceScore.homogeneous.GetFeatureValuesCategoryNumber();
dAppearanceScore2 = BrainMetastasisAppearanceScore.heterogeneous.GetFeatureValuesCategoryNumber();
viLabels = uint8(sum(m2dAppearanceScorePerSamplePerObserver == dAppearanceScore1 | m2dAppearanceScorePerSamplePerObserver == dAppearanceScore2,2) >=2 );
...
oRecord = CustomFeatureExtractionRecord(sLBLCode, "Homogeneous or Heterogeneous BM Appearance for Expert Consensus", m2dFeatures);
