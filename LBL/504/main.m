...
viLabels = uint8(vdAppearance == BrainMetastasisAppearanceScore.cysticComplex.GetFeatureValuesCategoryNumber()); 
...
oRecord = CustomFeatureExtractionRecord("LBL-504", "Cystic Complex BM Appearance from FV-500-200", m2dFeatures);
