...
viLabels = uint8(vdAppearance == BrainMetastasisAppearanceScore.necrosis.GetFeatureValuesCategoryNumber() | vdAppearance == BrainMetastasisAppearanceScore.heterogeneous.GetFeatureValuesCategoryNumber()); 
...
oRecord = CustomFeatureExtractionRecord("LBL-507", "Necrosis or Heterogeneous BM Appearance from FV-500-200", m2dFeatures);
