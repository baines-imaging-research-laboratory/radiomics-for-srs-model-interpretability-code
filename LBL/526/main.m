...
viLabels = uint8(vdAppearanceScorePerSample == dAppearanceScore1 | vdAppearanceScorePerSample == dAppearanceScore2);
...
oRecord = CustomFeatureExtractionRecord(sLBLCode, "Homogeneous or Heterogenous BM Appearance for Observer " + string(dObserver), m2dFeatures);
